function [RFR] = readPRARiskFreeRates(inputFolderRates,inputFileNameRates,sheetNameRates)
    ...
    RFRRaw = readtable(fullFilePath, ...
    "Sheet", sheetNameRates, ...
    'DataRange', 'b11:BC160', ...   % CORRECTED: 'Cll' is now 'C11'
    'ReadVariableNames', true, ...    % COMMA ADDED: after the DataRange value
    'VariableNamesRange', 'C3:BC3', ...
    'VariableNamingRule', 'preserve');    
    %RFRRaw = readtable(fullFilePath, "Sheet",sheetNameRates,'DataRange','C11:BC160','ReadVariableNames', true,'VariableNamesRange','C3:BC3','VariableNamingRule', 'preserve');
